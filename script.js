...
fetch(fullURL)
   ...
   .then ( data => {
      ...
      let image1 = data.items[0].volumeInfo.imageLinks.thumbnail
...
fetch(fullURL1)
   ...
   .then ( data => {
      ...
      let image1 = data.items[8].volumeInfo.imageLinks.thumbnail
...
fetch(fullURL2)
   ...
   .then ( data => {
      ...
      let image1 = data.items[1].volumeInfo.imageLinks.thumbnail
...
fetch(fullURL3)
   ...
   .then ( data => {
      ...
      let image2 = data.items[3].volumeInfo.imageLinks.thumbnail
